        ...
        <div className="mx-auto grid w-full max-w-5xl gap-16 px-4 md:gap-20 md:px-6">
          <FadeUp>
            ...
            <p className="mt-6 max-w-3xl text-base leading-7 text-foreground md:text-lg">
              ...
              entertaining. We envision a world where learning is not confined
              to traditional methods but is instead an immersive and enjoyable
          ...
          <FadeUp>
            ...
            <p className="mt-6 max-w-3xl text-base leading-7 text-foreground md:text-lg">
              ...
              knowledge to deliver a learning experience like no other. Our 3D
              Pixar-like characters bring industry experts to life, allowing
