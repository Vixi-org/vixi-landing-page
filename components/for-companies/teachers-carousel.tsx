        ...
        <div className="grid items-center gap-12 md:grid-cols-2 md:gap-16">
          ...
          >
            {TEACHERS.map((t) => (
              <li
                key={t.role}
                className="relative aspect-[3/4] w-[220px] shrink-0 snap-start overflow-hidden rounded-3xl bg-gradient-to-br shadow-[0_20px_50px_-25px_rgba(74,50,111,0.4)] md:w-[260px]"
              >
