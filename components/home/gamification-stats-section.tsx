      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
        ...
        <ul className="mt-16 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {STATS.map(({ Icon, title, body }) => (
            <li
              key={title}
              className="rounded-3xl border border-border/70 bg-background p-7 shadow-[0_15px_40px_-30px_rgba(74,50,111,0.4)] transition-shadow hover:shadow-[0_25px_60px_-30px_rgba(74,50,111,0.45)]"
            >
